...
# Create two separate lists with 10 random numbers each, between 1 and 50
...
# Compare the lists and track wins
player_one_wins = 0
player_two_wins = 0
...
# Find the highest and lowest numbers and their indices for each player
